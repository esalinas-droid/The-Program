/**
 * documents/[id].tsx — Document detail screen (Prompt 7A).
 *
 * Displays parsed text from an uploaded document.
 * Polls backend every 2 s while parseStatus is 'pending' or 'parsing'.
 * "Use this to build my plan" button is intentionally disabled (Prompt 7B scope).
 */
...
export default function DocumentDetailScreen() {
  ...
  return (
    <View style={[s.screen, { paddingTop: insets.top }]}>
      ...
      {/* Bottom action bar — "Use this to build my plan" button (DISABLED — Prompt 7B) */}
      {(isComplete || isFailed) && (
        <View style={[s.bottomBar, { paddingBottom: insets.bottom + SPACING.md }]}>
          <View style={s.disabledBtnWrap}>
            ...
            <Text style={s.disabledNote}>
              One-tap plan generation coming in a future update
            </Text>
          </View>
        </View>
      )}
